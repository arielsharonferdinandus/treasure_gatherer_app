          ...
          children: [
            Row(
              ...
              children: [
                Chip(
                  label: Text(
                    item.isForDisassemble ? "Kategori: For Disassemble" : "Kategori: Laman Utama",
                    style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold),
                  ),
                  backgroundColor: item.isForDisassemble ? Colors.orange.shade600 : primaryColor,
            ...
            const SizedBox(height: 4),
            Text(item.defectDescription, style: const TextStyle(fontSize: 15, color: Colors.red)),
            ...
            Row(
              ...
              children: [
                ElevatedButton(
                  ...
                  onPressed: () => _simulateReSell("sangat cepat"), 
                  child: const Text("Sangat Cepat (-2)"),
                ),
                ElevatedButton(
                  style: ElevatedButton.styleFrom(foregroundColor: primaryColor),
                  onPressed: () => _simulateReSell("cukup lama"), 
                  child: const Text("Cukup Lama (-1)"),
                ),
                ElevatedButton(
                  style: ElevatedButton.styleFrom(foregroundColor: primaryColor),
                  onPressed: () => _simulateReSell("sangat lama"), 
                  child: const Text("Sangat Lama (-2)"),
                ),
              ],
            )
          ],
